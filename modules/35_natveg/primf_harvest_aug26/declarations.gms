...
parameters
 ...
 p35_secdforest_natural(t,j,ac)                          Secdforest area from natural succession using uncalibrated natveg growth curve (mio. ha)
 ...
 p35_carbon_density_secdforest(t,j,ac,ag_pools)          Secdforest carbon density blending FRA-calibrated and uncalibrated natveg curves by natural-origin share (tC per ha)
 ...
 p35_secdf_ageclass(j,ac)                                Secondary forest area in 5-year age-classes (mio. ha)
...
* primf_harvest_aug26 additions
 p35_country_switch_clearcut(iso)                        Clear-cut wood harvest country switch (1)
 p35_cell_switch_clearcut(j)                             Clear-cut wood harvest cell switch (1)
 p35_clearcut_wood_recovery_share(i)                     Clear-cut wood recovery share relative to selective harvest (1)
 p35_clearcut_harvest_cost_m3(i)                         Clear-cut harvest cost as loaded from input (USD17MER per m3)
 p35_clearcut_harvest_cost(i)                            Clear-cut harvest cost converted to a per-biomass basis (USD17MER per tDM)
;
...
positive variables
  ...
  v35_secdforest_expansion(j)                            Secdforest expansion compared to previous timestep (mio. ha)
  ...
  v35_clearcut_primforest(j)                             Primary forest cleared for direct conversion with wood harvested (mio. ha)
...
parameters
 ...
 ov35_secdforest_expansion(t,j,type)                 Secdforest expansion compared to previous timestep (mio. ha)
 ...
 ov35_clearcut_primforest(t,j,type)                  Primary forest cleared for direct conversion with wood harvested (mio. ha)
