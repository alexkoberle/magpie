...
* countries where directly deforested primary forest may also earn wood-harvest revenue
  policy_countries35_clearcut(iso) Clear-cut wood harvest countries
  / BRA /

* regional parameters for the primary-forest clear-cut wood harvest pathway
  clearcut_par35 Clear-cut wood harvest parameters
  / recovery_share, harvest_cost_m3 /
