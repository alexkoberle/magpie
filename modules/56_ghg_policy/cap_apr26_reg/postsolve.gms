...
* ---- cap_apr26_reg: record regional slack levels for platform signalling ----
*' Non-zero p56_emis_cap_slack(t,i) signals that region i's cap was infeasible
*' for this timestep; the platform should adjust that region's budget accordingly.
p56_emis_cap_slack(t,i) = v56_slack_emis_cap.l(i);

*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ov_carbon_stock(t,j,land,c_pools,stockType,"marginal")   = vm_carbon_stock.m(j,land,c_pools,stockType);
 ov56_slack_emis_cap(t,i,"marginal")                      = v56_slack_emis_cap.m(i);
 ...
 oq56_emis_cap(t,i,"marginal")                            = q56_emis_cap.m(i);
 ov_carbon_stock(t,j,land,c_pools,stockType,"level")      = vm_carbon_stock.l(j,land,c_pools,stockType);
 ov56_slack_emis_cap(t,i,"level")                         = v56_slack_emis_cap.l(i);
 ...
 oq56_emis_cap(t,i,"level")                               = q56_emis_cap.l(i);
 ov_carbon_stock(t,j,land,c_pools,stockType,"upper")      = vm_carbon_stock.up(j,land,c_pools,stockType);
 ov56_slack_emis_cap(t,i,"upper")                         = v56_slack_emis_cap.up(i);
 ...
 oq56_emis_cap(t,i,"upper")                               = q56_emis_cap.up(i);
 ov_carbon_stock(t,j,land,c_pools,stockType,"lower")      = vm_carbon_stock.lo(j,land,c_pools,stockType);
 ov56_slack_emis_cap(t,i,"lower")                         = v56_slack_emis_cap.lo(i);
 ...
 oq56_emis_cap(t,i,"lower")                               = q56_emis_cap.lo(i);
