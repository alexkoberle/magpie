...
* ---- cap_apr26_reg: load regional cap trajectory ----
*' Set non-binding (1e6) for all regions/periods; override with chosen scenario.
*' Historic periods (<=sm_fix_SSP2) and pre-start periods are always non-binding.
...
* ---- cap_apr26_reg: initialise source bounds ----
