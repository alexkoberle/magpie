...
* ---- cap_apr26_ref: record slack level for platform signalling ----
...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov56_emis_co2eq(t,i,emis_source,pollutants,"marginal")   = v56_emis_co2eq.m(i,emis_source,pollutants);
 ...
 oq56_emis_co2eq(t,i,emis_source,pollutants,"marginal")   = q56_emis_co2eq.m(i,emis_source,pollutants);
 ...
 ov56_emis_co2eq(t,i,emis_source,pollutants,"level")      = v56_emis_co2eq.l(i,emis_source,pollutants);
 ...
 oq56_emis_co2eq(t,i,emis_source,pollutants,"level")      = q56_emis_co2eq.l(i,emis_source,pollutants);
 ...
 ov56_emis_co2eq(t,i,emis_source,pollutants,"upper")      = v56_emis_co2eq.up(i,emis_source,pollutants);
 ...
 oq56_emis_co2eq(t,i,emis_source,pollutants,"upper")      = q56_emis_co2eq.up(i,emis_source,pollutants);
 ...
 ov56_emis_co2eq(t,i,emis_source,pollutants,"lower")      = v56_emis_co2eq.lo(i,emis_source,pollutants);
 ...
 oq56_emis_co2eq(t,i,emis_source,pollutants,"lower")      = q56_emis_co2eq.lo(i,emis_source,pollutants);
